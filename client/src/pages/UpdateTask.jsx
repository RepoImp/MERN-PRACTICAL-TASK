...
const UpdateTask = () => {
  ...
  const { serverOrigin, token } = useContext(AppContext);
  ...
  const getTaskbyId = async () => {
    try {
      const res = await axios.get(`${serverOrigin}/task/get/byid/${task_id}`, {
  ...
  const addTask = async (e) => {
    ...
    try {
      const res = await axios.put(`${serverOrigin}/task/update`, formData, {
        headers: { "Content-Type": "application/json", token },
      });
